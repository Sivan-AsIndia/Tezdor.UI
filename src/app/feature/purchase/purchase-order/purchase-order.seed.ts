...
export const SAMPLE_ORDERS: PurchaseOrder[] = [
  {
    ...
    lineItems: [
      ...
      { id: 2, itemId: 102, productCode: 'PRD111', productName: 'Teak Wood Plank', unitId: 6, unitName: 'Mtr', quantity: 20, receivedQuantity: 20, pendingQuantity: 0, unitPrice: 800, taxPercent: 18, discount: 200, total: 18640 },
    ],
  ...
  },
  {
    ...
    lineItems: [
      ...
      { id: 2, itemId: 302, productCode: 'PRD306', productName: 'PVC Elbow 25mm', unitId: 1, unitName: 'Pcs', quantity: 50, receivedQuantity: 20, pendingQuantity: 30, unitPrice: 18, taxPercent: 12, discount: 0, total: 1008 },
    ],
  ...
  },
  {
    ...
    deliveryMethod: 'delivery', paymentTerms: 'net30',
    lineItems: [
      { id: 1, itemId: 103, productCode: 'PRD112', productName: 'Block Board 19mm', unitId: 1, unitName: 'Pcs', quantity: 40, receivedQuantity: 15, pendingQuantity: 25, unitPrice: 1200, taxPercent: 18, discount: 1000, total: 57640 },
    ],
  ...
  },
  {
    ...
    lineItems: [
      { id: 1, itemId: 202, productCode: 'PRD201', productName: 'MS Flat Bar 40x6mm', unitId: 2, unitName: 'Kg', quantity: 500, receivedQuantity: 0, pendingQuantity: 500, unitPrice: 82, taxPercent: 18, discount: 2000, total: 46380 },
    ],
  ...
  },
  {
    ...
    lineItems: [
      ...
      { id: 2, itemId: 502, productCode: 'PRD501', productName: 'Safety Gloves', unitId: 5, unitName: 'Dozen', quantity: 10, receivedQuantity: 10, pendingQuantity: 0, unitPrice: 280, taxPercent: 12, discount: 0, total: 3136 },
    ],
  ...
  },
  {
    ...
    deliveryMethod: 'pickup', paymentTerms: 'advance',
    lineItems: [
      { id: 1, itemId: 303, productCode: 'PRD308', productName: 'CPVC Pipe 20mm', unitId: 6, unitName: 'Mtr', quantity: 100, receivedQuantity: 40, pendingQuantity: 60, unitPrice: 72, taxPercent: 12, discount: 0, total: 8064 },
    ],
...

  {
    ...
    status: 'draft', createdAt: '2026-02-10',
  },
  {
    id: 10, poNumber: 'PO-2026-010',
    vendorId: '5', vendorCode: 'VEN005', vendorName: 'Apex Hardware',
    orderDate: '2026-02-12', expectedDate: '2026-03-01',
    deliveryMethod: 'courier', paymentTerms: 'net15',
    lineItems: [
      { id: 1, itemId: 402, productCode: 'PRD401', productName: 'Nut M12', unitId: 4, unitName: 'Box', quantity: 20, receivedQuantity: 0, pendingQuantity: 20, unitPrice: 180, taxPercent: 18, discount: 0, total: 4248 },
      { id: 2, itemId: 403, productCode: 'PRD402', productName: 'Washer M12', unitId: 4, unitName: 'Box', quantity: 20, receivedQuantity: 0, pendingQuantity: 20, unitPrice: 120, taxPercent: 18, discount: 0, total: 2832 },
    ],
    subTotal: 6000, taxAmount: 1080, discountAmount: 0, shippingCharge: 200, grandTotal: 7280,
    status: 'sent_to_supplier', createdAt: '2026-02-12',
  },
];