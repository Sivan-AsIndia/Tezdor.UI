...
const YASHIKA_BOM: BomNode[] = [
  ...
  },
  {
    ...
    quantity: 2, unitId: 'sheet', unitName: 'Sheet',
  ...
  },
  {
    ...
    quantity: 3, unitId: 'nos', unitName: 'Nos',
  ...
  },
  {
    ...
    quantity: 5, unitId: 'mtr', unitName: 'Meter',
  ...
  },
  {
    ...
    quantity: 3, unitId: 'mtr', unitName: 'Meter',
  ...
  },
  {
    ...
    quantity: 24, unitId: 'nos', unitName: 'Nos',
  ...
  },
  {
    ...
    rawMaterialId: 'RM-FB-001', rawMaterialName: 'Linen Fabric (Beige)',
    quantity: 2.5, unitId: 'mtr', unitName: 'Meter',
    wastagePercent: 7, costPerUnit: 420, isOptional: false,
    processingNotes: '',
    isExpanded: true, isEditing: false, hasError: false, sortOrder: 3,
  },
  ...
  // ── L1: Sofa Legs Set ──
  {
    ...
    quantity: 20, unitId: 'nos', unitName: 'Nos',
...
const RECLINER_BOM: BomNode[] = [
  ...
  },
  {
    ...
    quantity: 1, unitId: 'sheet', unitName: 'Sheet',
  ...
  },
  {
    ...
    quantity: 4.5, unitId: 'mtr', unitName: 'Meter',
  ...
  },
  {
    ...
    quantity: 4, unitId: 'nos', unitName: 'Nos',
...
const MILANO_BOM: BomNode[] = [
  ...
  },
  {
    ...
    quantity: 6, unitId: 'mtr', unitName: 'Meter',
  ...
  },
  {
    ...
    rawMaterialId: 'RM-FB-002', rawMaterialName: 'Velvet Fabric (Royal Blue)',
    quantity: 4, unitId: 'mtr', unitName: 'Meter',
    wastagePercent: 8, costPerUnit: 550, isOptional: false,
    processingNotes: '',
    isExpanded: true, isEditing: false, hasError: false, sortOrder: 3,
  },
  {
    ...
    rawMaterialId: 'RM-HW-004', rawMaterialName: 'Sofa Leg (Chrome, 3 in)',
    quantity: 10, unitId: 'nos', unitName: 'Nos',
    wastagePercent: 0, costPerUnit: 120, isOptional: false,
    processingNotes: '',
    isExpanded: true, isEditing: false, hasError: false, sortOrder: 3,
  },
...
const DINING_BOM: BomNode[] = [
  ...
  },
  {
    ...
    rawMaterialId: 'RM-WD-001', rawMaterialName: 'Sheesham Wood Plank',
    quantity: 2, unitId: 'set', unitName: 'Set',
  ...
  },
  {
    ...
    quantity: 1.5, unitId: 'ltr', unitName: 'Litre',
  ...
  },
  {
    ...
    rawMaterialId: null, rawMaterialName: null,
    quantity: 6, unitId: 'nos', unitName: 'Nos',
    wastagePercent: 0, costPerUnit: null, isOptional: false,
...
const BED_BOM: BomNode[] = [
  ...
  },
  {
    ...
    quantity: 4, unitId: 'sheet', unitName: 'Sheet',
  ...
  },
  {
    ...
    quantity: 2, unitId: 'ltr', unitName: 'Litre',
...
const CHESTERFIELD_BOM: BomNode[] = [
  ...
  },
  {
    ...
    rawMaterialId: 'RM-FB-004', rawMaterialName: 'Genuine Leather (Tan)',
    quantity: 8, unitId: 'mtr', unitName: 'Meter',
