...
const AdminSettings = {
  ...
  ManageColorThemeLayout() {
    ...
    Green_Theme: "green-theme-layout",
    Cyan_Theme: "cyan-theme-layout",
    Orange_Theme: "orange-theme-layout",
  };

  const elementId = themeMap[ColorTheme];
  if (elementId) {
...
window.InitAppMin = function () {
  ...
  function handleDirection() {
    ...
    if (rtlLayoutElement) {
      rtlLayoutElement.addEventListener("click", function () {
        document.documentElement.setAttribute("dir", "rtl");
        updateSetting("Direction", "rtl"); // ✅ Save
        const offcanvasEnd = document.querySelector(".offcanvas-end");
        if (offcanvasEnd) {
          offcanvasEnd.classList.toggle("offcanvas-start");
          offcanvasEnd.classList.remove("offcanvas-end");
    ...
    if (ltrLayoutElement) {
      ltrLayoutElement.addEventListener("click", function () {
        document.documentElement.setAttribute("dir", "ltr");
        updateSetting("Direction", "ltr"); // ✅ Save
        const offcanvasStart = document.querySelector(".offcanvas-start");
        if (offcanvasStart) {
          offcanvasStart.classList.toggle("offcanvas-end");
          offcanvasStart.classList.remove("offcanvas-start");
  ...
  function handleBoxedLayout() {
    ...
    if (boxedLayout) {
      boxedLayout.addEventListener("click", function () {
        containerFluid.forEach((el) => el.classList.remove("mw-100"));
        document.documentElement.setAttribute("data-boxed-layout", "boxed");
        updateSetting("BoxedLayout", true); // ✅ Save
      });
    }

    if (fullLayout) {
      fullLayout.addEventListener("click", function () {
        containerFluid.forEach((el) => el.classList.add("mw-100"));
        document.documentElement.setAttribute("data-boxed-layout", "full");
        updateSetting("BoxedLayout", false); // ✅ Save
      });
    }
  }
  handleBoxedLayout();
  ...
  function handleLayout() {
    ...
    if (verticalLayout) {
      verticalLayout.addEventListener("click", function () {
        document.documentElement.setAttribute("data-layout", "vertical");
        updateSetting("Layout", "vertical"); // ✅ Save
      });
    }
    ...
    if (horizontalLayout) {
      horizontalLayout.addEventListener("click", function () {
        document.documentElement.setAttribute("data-layout", "horizontal");
        updateSetting("Layout", "horizontal"); // ✅ Save
      });
    }
  }
  handleLayout();
  ...
  function handleTheme() {
    function setThemeAttributes(theme, darkDisplay, lightDisplay, sunDisplay, moonDisplay) {
      ...
      updateSetting("Theme", theme); // ✅ Save
    }
  ...
  function handleSidebarToggle() {
    ...
    if (fullSidebarElement) {
      fullSidebarElement.addEventListener("click", () => {
        document.body.setAttribute("data-sidebartype", "full");
        updateSetting("SidebarType", "full"); // ✅ Save
      });
    }
    if (miniSidebarElement) {
      miniSidebarElement.addEventListener("click", () => {
        document.body.setAttribute("data-sidebartype", "mini-sidebar");
        updateSetting("SidebarType", "mini-sidebar"); // ✅ Save
      });
    }
  }
  handleSidebarToggle();
